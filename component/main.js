...
/***/ function(module, exports, __webpack_require__) {
	...
	var SvgIcon = (function (_React$Component) {
	    ...
	    _createClass(SvgIcon, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            // Elements to inject
	            var mySVGsToInject = _react2['default'].findDOMNode(this.refs.inject);
	            //options
	            var options = {
	                evalScripts: 'never'
	            };
	            // Do the injection
	            (0, _svgInjector2['default'])(mySVGsToInject, options);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	
	            return _react2['default'].createElement('img', { ref: 'inject', className: this.props.classname, src: this.props.iconSrc, 'data-fallback': this.props.pngSrc });
	        }
	    }]);
	...
	SvgIcon.PropTypes = {
	    ...
	    iconSrc: _react2['default'].PropTypes.string.isRequired,
	    classs: _react2['default'].PropTypes.string
